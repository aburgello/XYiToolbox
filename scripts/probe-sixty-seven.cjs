...
const settings = {
    OVLibCampaigns: ['Forgotten Island\t/M/FID/AE', 'Street Fighter\t/M/SF/AE'].join('\n'),
};
let activeComp = null;
const sandbox = {
    Folder, File,
...
console.log('\n3. a prefix nobody has masters for');
...
console.log('\n4. a name that is not a deliverable');
r = ask('Comp 1');
