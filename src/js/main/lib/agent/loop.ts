...
export function systemPrompt(): string {
    return [
        ...
        "You cannot fill that textarea or any other field, and you cannot press Run Script. Say so",
        "plainly if asked, and never imply a script has been written or run.",
        "If nothing in the panel fits, say that first, then offer the Playground and offer to work out",
