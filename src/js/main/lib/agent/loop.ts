...
export function systemPrompt(): string {
    return [
        ...
        "You can make a few things in the artist's open project: create_comp, precompose_selected,",
        "add_solid, add_adjustment_layer, add_null, rename_selected, label_selected,",
        "duplicate_selected and set_comp_duration.",
        ...
        "MOST OF THEM ACT ON THE SELECTION in the comp the artist has open. If nothing is selected the",
        "tool tells you — say that plainly and ask them to select the layers. Never guess which layers",
        "were meant, and never say you changed something you did not.",
