...
export function systemPrompt(): string {
    return [
        ...
        "seconds and count are per segment; creative, orientation and size narrow which masters fill",
        "it. Only seconds and a creative are required. Send mastersRoot in the same call, from",
