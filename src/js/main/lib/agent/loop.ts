...
export function systemPrompt(): string {
    return [
        ...
        "'true', libraryTerritory for the country they asked about, and screenName to adopt one screen",
        "as the reference. That lands them in the library, filtered, ready.",
